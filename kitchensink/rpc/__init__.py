...
from ..errors import UnauthorizedAccess, UnknownFunction
...
class RPC(object):
    ...
    def call(self, func_string, args_string, kwargs_string, fmt, 
        ...
        if async:
            ...
            return self.instant_call(func_string, args_string, kwargs_string, fmt)
    def instant_call(self, func_string, args_string, kwargs_string, fmt):
        try:
            ...
            return Status.FINISHED, {'fmt' : fmt}, fmt.serialize(result)
        except Exception as e:
            exc_info = traceback.format_exc()
            return Status.FAILED, {'fmt' : fmt}, exc_info

    def resolve_function(self, func_string, serialized_function):
    ...
    def register_function(self, func, name, default_fmt):
