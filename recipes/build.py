...
if __name__ == "__main__":
    ...
    #build("dill", args.build_dir, args.py, args.plat, args.binstar_user)
    build("rq", args.build_dir, args.py, args.plat, args.binstar_user)
    build("simpleservices", args.build_dir, args.py, args.plat, args.binstar_user)
    build("kitchensink", args.build_dir, args.py, args.plat, args.binstar_user)
    """
